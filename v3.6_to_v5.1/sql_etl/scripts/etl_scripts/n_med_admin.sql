...
where
	...
	and drug_source_value not ilike '%breastmilk%' 
					   and drug_source_value not ilike '%formulae%' 
					   and drug_source_value not ilike '%tpn%' 
					   and	drug_source_value not ilike '%custom%'; 

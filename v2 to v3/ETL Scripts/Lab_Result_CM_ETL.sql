...
insert into dcc_pcornet.lab_result_cm (
	lab_result_cm_id,
	patid, encounterid,
...
from	 
	...
	join dcc_pcornet.demographic d on cast(m.person_id as text)= d.patid
	...
	left join public.cz_omop_pcornet_concept_map m1 on c1.concept_code = m1.source_concept_id and m1.source_concept_class = 'Lab name'

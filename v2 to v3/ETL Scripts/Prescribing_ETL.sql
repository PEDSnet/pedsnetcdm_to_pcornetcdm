...
select 
	...
	null as rx_order_date, -- order date is not available in PEDSnet CDM. Use drug_exposure start date instead?
	null as rx_order_time, -- same as above
	...
	null as rx_frequency, -- need to convert effective dose to rx_frequency
...
where
	de.drug_type_concept_id IN ('38000180','38000177') -- 38000180 = Inpatient administration, 38000177 = Prescription written

...
insert into chop_start2001_pcornet.procedures(
...
select distinct 
	...
	po.site as site
from
	chop_pedsnet.procedure_occurrence po
	join chop_start2001_pcornet.encounter enc on cast(po.visit_occurrence_id as text)=enc.encounterid
	...
	left join chop_start2001_pcornet.cz_omop_pcornet_concept_map m1 on c.vocabulary_id = m1.source_concept_id AND m1.source_concept_class='Procedure Code Type'
	...
	left join chop_start2001_pcornet.cz_omop_pcornet_concept_map m3 on c2.vocabulary_id = m3.source_concept_id AND m3.source_concept_class='Procedure Code Type'
where
	po.visit_occurrence_id IN (select visit_id from chop_start2001_pcornet.person_visit_start2001);

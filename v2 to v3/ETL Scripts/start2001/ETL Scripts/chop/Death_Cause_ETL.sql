Insert into chop_start2001_pcornet.death_cause(
	patid,
...
From
	...
	join chop_start2001_pcornet.demographic d on cast(de.person_id as text) = d.patid
	join vocabulary.concept on cause_source_concept_id = concept_id
	left join chop_start2001_pcornet.cz_omop_pcornet_concept_map m1 on cast(vocabulary_id as text) = source_concept_id 
	AND m1.source_concept_class='death cause code' 
where 
	cause_source_value is not null and
	cause_source_concept_id<>44814650 and

...
insert into chop_start2001_pcornet.condition(
...
from
	...
	join chop_start2001_pcornet.demographic d on d.patid = cast(co.person_id as text)
	left join chop_start2001_pcornet.encounter e on e.encounterid = cast(co.visit_occurrence_id as text)

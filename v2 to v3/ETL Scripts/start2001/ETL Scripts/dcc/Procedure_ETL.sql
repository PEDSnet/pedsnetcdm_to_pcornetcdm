...
from
	...
	join dcc_start2001_pcornet.encounter enc on cast(po.visit_occurrence_id as text)=enc.encounterid
	...
	left join dcc_start2001_pcornet.cz_omop_pcornet_concept_map m1 on c.vocabulary_id = m1.source_concept_id AND m1.source_concept_class='Procedure Code Type'

...
ob_tobacco as ( select distinct observation_id, visit_occurrence_id, observation_date, coalesce(m1.target_concept,'OT') as tobacco 
...
ob_tobacco_type as (select distinct observation_id, visit_occurrence_id, observation_date, coalesce(m2.target_concept,'OT') as tobacco_type 
	from observation o1 
...
ob_smoking as (select distinct observation_id, visit_occurrence_id, observation_date, coalesce(m3.target_concept,'OT') as smoking 
...
ob_tobacco_data as (select ob_tobacco.visit_occurrence_id, ob_tobacco.observation_date, ob_tobacco.tobacco, ob_tobacco_type.tobacco_type, ob_smoking.smoking  
	from ob_tobacco 
...
and ms.measurement_date = ob_tobacco_data.observation_date

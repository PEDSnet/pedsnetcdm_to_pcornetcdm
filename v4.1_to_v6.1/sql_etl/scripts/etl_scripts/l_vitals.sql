...
(
	...
	where measurement_concept_id = '3023540' and measurement_type_concept_id <> '44818704' 
);
commit;
...
(
   select person_id, 'SITE' as site, measurement_id,visit_occurrence_id, measurement_date, measurement_datetime, value_as_number
	...
	value_source_value
	from SITE_pedsnet.measurement
	where measurement_concept_id = '3013762' and measurement_type_concept_id <> '44818704' 
);
commit;
begin;

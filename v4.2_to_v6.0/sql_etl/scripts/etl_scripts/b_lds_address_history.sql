...
INSERT INTO SITE_pcornet.lds_address_history(
	address_city, address_period_end, address_period_start, address_preferred, address_state, address_type, address_use, address_zip5, address_zip9, addressid, patid)
select
...
inner join SITE_pedsnet.location_history loc_his on loc.location_id = loc_his.location_id and lower(loc_his.domain_id) = 'person'

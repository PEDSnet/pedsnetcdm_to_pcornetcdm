...
-- (
--     select  distinct person_id, measurement_id,visit_occurrence_id, measurement_date, measurement_datetime, value_as_number
...
-- 	where measurement_concept_id in (3023540,3019171,3036277)
-- );
-- commit;
...
-- (
--    select person_id, measurement_id,visit_occurrence_id, measurement_date, measurement_datetime, value_as_number
-- 	,  measurement_concept_id,measurement_source_value, provider_id,operator_concept_id, unit_concept_id, unit_source_value, value_as_concept_id,
-- 	value_source_value
-- 	from SITE_pedsnet.measurement
-- 	where measurement_concept_id in (3013762,3023166,3025315,3013762)
-- );
-- commit;
-- -- begin;
...
-- (
--     select distinct person_id, measurement_id,visit_occurrence_id, provider_id, value_as_concept_id,
...
-- (
--     select distinct person_id,  measurement_id, provider_id, value_as_concept_id,
...
-- 	select person_id,  measurement_id, visit_occurrence_id, value_as_concept_id, measurement_date, measurement_datetime, value_as_number, measurement_concept_id, measurement_source_value, provider_id,operator_concept_id, unit_concept_id, unit_source_value,
-- 	value_source_value
...
(
    ...
    value_as_string, coalesce(m1.target_concept,'OT') as tobacco, qualifier_concept_id
...
(
    select distinct visit_occurrence_id, observation_concept_id, observation_source_value,person_id,o1.value_as_concept_id, observation_date, observation_datetime, coalesce(m2.target_concept,'OT') as tobacco_type, qualifier_source_value,observation_id, qualifier_concept_id,provider_id
	from SITE_pedsnet.observation o1 
...
(
    select distinct observation_id, observation_source_value, visit_occurrence_id,person_id, o1.value_as_concept_id, observation_date, observation_datetime, coalesce(m3.target_concept,'OT') as smoking, observation_concept_id, qualifier_concept_id,qualifier_source_value,provider_id
...
(
	...
	ob_tobacco.observation_id, ob_tobacco.observation_source_value,ob_tobacco.qualifier_concept_id,ob_tobacco.qualifier_source_value
	from SITE_pcornet.ob_tobacco
	left join SITE_pcornet.ob_tobacco_type 
        on ob_tobacco.observation_date = ob_tobacco_type.observation_date
        and ob_tobacco.observation_date = ob_tobacco_type.observation_date
        and ob_tobacco.visit_occurrence_id = ob_tobacco_type.visit_occurrence_id
    left join SITE_pcornet.ob_smoking 
        on ob_tobacco.observation_date = ob_smoking.observation_date
        and ob_tobacco.observation_date = ob_smoking.observation_date
        and ob_tobacco.visit_occurrence_id = ob_smoking.visit_occurrence_id
);
...
and ms.measurement_datetime = ms_dia.measurement_datetime;
commit;

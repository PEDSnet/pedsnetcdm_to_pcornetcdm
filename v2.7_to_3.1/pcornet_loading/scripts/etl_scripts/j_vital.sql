...
ob_tobacco as (
	            ...
	            left join SITE_3dot1_pcornet.pedsnet_pcornet_valueset_map m1 on cast(o1.value_as_concept_id as text) = m1.source_concept_id
...
ob_smoking as (
	             ...
	             from SITE_pedsnet.observation o1
	             left join SITE_3dot1_pcornet.pedsnet_pcornet_valueset_map m3 on cast(o1.value_as_concept_id as text)= m3.source_concept_id
...
left join SITE_3dot1_pcornet.pedsnet_pcornet_valueset_map m on cast(ms_sys.measurement_concept_id as text) = m.source_concept_id AND

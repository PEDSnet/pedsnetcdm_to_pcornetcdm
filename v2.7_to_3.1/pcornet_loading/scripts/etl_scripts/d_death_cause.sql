begin;
Insert into SITE_3dot1_pcornet.death_cause(
	patid,
...
From
	...
	join SITE_3dot1_pcornet.demographic d on cast(de.person_id as text) = d.patid
	join vocabulary.concept on cause_source_concept_id = concept_id
	left join SITE_3dot1_pcornet.pedsnet_pcornet_valueset_map m1 on cast(vocabulary_id as text) = source_concept_id

begin;
alter table SITE_3dot1_start2001_pcornet.lab_result_cm  alter result_num SET DATA TYPE NUMERIC(25,8);


-- more changes likely to be made based on decisions in data models #203 and #204
insert into SITE_3dot1_start2001_pcornet.lab_result_cm (
	lab_result_cm_id,
	patid, encounterid,
...
select
	...
	abn_ind,
	raw_lab_name, raw_lab_code, raw_panel, raw_result, raw_unit, raw_order_dept, raw_facility_code, site
	 from SITE_3dot1_pcornet.lab_result_cm
where

...
from
	...
	left join SITE_3dot1_pcornet.pedsnet_pcornet_valueset_map m1 on c1.concept_code = m1.source_concept_id and
	                                                                m1.source_concept_class = 'Lab name'
	left join SITE_3dot1_pcornet.pedsnet_pcornet_valueset_map m3 on cast(m.operator_concept_id as text) = m3.source_concept_id and
	                                                               m3.source_concept_class = 'Result modifier'
	left join SITE_3dot1_pcornet.pedsnet_pcornet_valueset_map m4 on cast(m.unit_concept_id as text)= m4.source_concept_id and
	                                                                m4.source_concept_class = 'Unit'
	left join SITE_3dot1_pcornet.pedsnet_pcornet_valueset_map m5 on cast(m.range_low_operator_concept_id as text)= m5.source_concept_id and
	                                                                m5.source_concept_class = 'Result modifier'
	left join SITE_3dot1_pcornet.pedsnet_pcornet_valueset_map m6 on cast(m.range_high_operator_concept_id as text)= m6.source_concept_id and
	                                                                m6.source_concept_class = 'Result modifier'
	left join SITE_3dot1_pcornet.pedsnet_pcornet_valueset_map m7 on cast(m.priority_concept_id as text)= m7.source_concept_id and
	                                                                m7.source_concept_class = 'Lab priority'
	left join SITE_3dot1_pcornet.pedsnet_pcornet_valueset_map m8 on cast(m.value_as_concept_id as text)= m8.source_concept_id and

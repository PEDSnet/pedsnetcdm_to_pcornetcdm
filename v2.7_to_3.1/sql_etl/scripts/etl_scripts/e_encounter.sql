...
from
	...
	left join SITE_3dot1_pcornet.pedsnet_pcornet_valueset_map m2 on case when dis_disposition.value_as_concept_id is null AND m2.value_as_concept_id is null
	                                                                     then true
	...
	left join SITE_3dot1_pcornet.pedsnet_pcornet_valueset_map m4a on v.admitting_source_concept_id = m4a.source_concept_id::integer
			and m4a.source_concept_class='Admitting source'
	left join SITE_3dot1_pcornet.pedsnet_pcornet_valueset_map m3a on cast(v.discharge_to_concept_id as text) = m3a.source_concept_id

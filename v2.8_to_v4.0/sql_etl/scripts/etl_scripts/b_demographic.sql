...
from
	...
	left join SITE_4dot0_pcornet.pedsnet_pcornet_valueset_map m4 on case when p.language_concept_id is null AND m4.source_concept_id is null then true else cast(p.language_concept_id as text) = m4.source_concept_id end and m4.source_concept_class = 'Language'

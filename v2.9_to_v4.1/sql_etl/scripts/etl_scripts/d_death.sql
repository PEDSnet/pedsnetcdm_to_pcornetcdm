...
Insert into SITE_4dot0_pcornet.death(
...
From
	...
	left join SITE_4dot0_pcornet.pedsnet_pcornet_valueset_map m1 on m1.source_concept_class='Death date impute' and
	cast(de.death_impute_concept_id as text) = m1.source_concept_id
Where
	de.death_type_concept_id  = 38003569 and
	person_id IN (select person_id from SITE_4dot0_pcornet.person_visit_start2001)

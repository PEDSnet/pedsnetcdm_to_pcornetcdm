...
(
   select measurement_id, person_id, visit_occurrence_id, measurement_concept_id, measurement_source_Concept_id, measurement_source_value,
    	...
    	value_as_number, range_low, range_high, unit_source_value, unit_concept_id, value_as_concept_id,measurement_type_concept_id, priority_source_value,
		range_high_source_value, range_low_source_value, operator_concept_id,range_low_operator_concept_id, range_high_operator_concept_id,
		measurement_age_in_months,  value_source_value,measurement_result_age_in_months, measurement_concept_name, measurement_source_concept_name,
...
select distinct on (measurement_concept_id) measurement_concept_id, measurement_date, measurement_datetime, measurement_order_date, measurement_order_datetime,
            ...
            range_high_source_value, range_low, range_low_operator_concept_id, range_low_source_value, specimen_concept_id, specimen_source_value,
                unit_concept_id, unit_source_value, m.value_as_concept_id, value_as_number, value_source_value, measurement_age_in_months,
                measurement_result_age_in_months, measurement_concept_name, measurement_source_concept_name, measurement_type_concept_name,
...
left join pcornet_maps.valueset_map m4 on cast(m.unit_concept_id as text)= m4.source_concept_id and m4.source_concept_class = 'Result unit'

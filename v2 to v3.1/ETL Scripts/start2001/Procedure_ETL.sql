...
select 
	* from dcc_3dot1_pcornet.procedures
where
	 patid IN (select cast(person_id as text) from dcc_3dot1_start2001_pcornet.person_visit_start2001) and EXTRACT(YEAR FROM px_date) >= 2001;

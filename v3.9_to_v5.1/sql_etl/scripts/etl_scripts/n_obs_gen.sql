...
as
select obsgenid,patid,encounterid,obsgen_providerid, obsgen_date,obsgen_time,
...
raw_obsgen_result,raw_obsgen_unit,meas.site
...
as
select distinct obsgenid,patid,encounterid,obsgen_providerid, obsgen_date,obsgen_time,
...
as
select distinct obsgenid,dev.patid,dev.encounterid,dev.obsgen_providerid,dev.obsgen_date,obsgen_time,
obsgen_type,obsgen_code,obsgen_result_qual,
...
raw_obsgen_result,raw_obsgen_unit,dev.site
...
select distinct obsgenid, patid, encounterid, obsgen_providerid,  obsgen_date,obsgen_time, obsgen_type, obsgen_code, obsgen_result_qual, 

...
insert into chop_start2001_pcornet.vital(
...
ms as (select  person_id, min(site) as site,visit_occurrence_id,measurement_date, measurement_time  
		from chop_pedsnet.measurement where measurement_concept_id IN ('3023540','3013762','3034703','3019962','3013940','3012888','3018586','3035856','3009395','3004249','3038553')
		group by person_id, visit_occurrence_id,measurement_date, measurement_time  
		),
ms_ht as (select distinct measurement_id, visit_occurrence_id, measurement_date, measurement_time, value_as_number  from chop_pedsnet.measurement where measurement_concept_id = '3023540'),
ms_wt as (select distinct measurement_id,visit_occurrence_id, measurement_date, measurement_time, value_as_number  from chop_pedsnet.measurement where measurement_concept_id = '3013762'),
ms_bmi as (select distinct measurement_id,visit_occurrence_id, measurement_date, measurement_time, value_as_number  from chop_pedsnet.measurement where measurement_concept_id = '3038553'),
ms_sys as (select distinct measurement_id, visit_occurrence_id, measurement_date, measurement_time, value_as_number, value_as_concept_id, measurement_concept_id,measurement_source_value from chop_pedsnet.measurement where measurement_concept_id in ('3018586','3035856','3009395','3004249')),
ms_dia as (select distinct measurement_id, visit_occurrence_id, measurement_date, measurement_time, measurement_type_concept_id, value_as_number, measurement_source_value from chop_pedsnet.measurement where measurement_concept_id in ('3034703','3019962','3013940','3012888')),
ms_vs as (select distinct measurement_id, visit_occurrence_id, measurement_date, measurement_time, measurement_type_concept_id from chop_pedsnet.measurement where measurement_type_concept_id IN ('44814721')),
ob_tobacco as ( select distinct observation_id, visit_occurrence_id, observation_date, observation_time,coalesce(m1.target_concept,'OT') as tobacco 
	from chop_pedsnet.observation o1 left join chop_start2001_pcornet.cz_omop_pcornet_concept_map m1 on cast(o1.value_as_concept_id as text) = m1.source_concept_id
...
ob_tobacco_type as (select distinct observation_id, visit_occurrence_id, observation_date, observation_time, coalesce(m2.target_concept,'OT') as tobacco_type 
	from chop_pedsnet.observation o1 
	left join chop_start2001_pcornet.cz_omop_pcornet_concept_map m2 on cast(o1.value_as_concept_id as text) = m2.source_concept_id
...
ob_smoking as (select distinct observation_id, visit_occurrence_id, observation_date, observation_time, coalesce(m3.target_concept,'OT') as smoking 
	from chop_pedsnet.observation o1 left join chop_start2001_pcornet.cz_omop_pcornet_concept_map m3 on cast(o1.value_as_concept_id as text)= m3.source_concept_id
...
ob_tobacco_data as (select ob_tobacco.visit_occurrence_id, ob_tobacco.observation_date, ob_tobacco.observation_time, ob_tobacco.tobacco, ob_tobacco_type.tobacco_type, ob_smoking.smoking  
	from ob_tobacco 
	left join chop_pedsnet.fact_relationship fr2 on ob_tobacco.observation_id = fr2.fact_id_1 
	join ob_tobacco_type on fr2.fact_id_2 = ob_tobacco_type.observation_id
	left join chop_pedsnet.fact_relationship fr3 on ob_tobacco.observation_id = fr3.fact_id_1 
...
left join chop_pedsnet.fact_relationship fr1 on fr1.fact_id_1 = ms_sys.measurement_id AND fr1.domain_concept_id_1=21 AND fr1.domain_concept_id_2=21
...
left join chop_start2001_pcornet.cz_omop_pcornet_concept_map m on cast(ms_sys.measurement_concept_id as text) = m.source_concept_id AND m.source_concept_class='BP Position'
...
ms.visit_occurrence_id IN (select visit_id from chop_start2001_pcornet.person_visit_start2001)

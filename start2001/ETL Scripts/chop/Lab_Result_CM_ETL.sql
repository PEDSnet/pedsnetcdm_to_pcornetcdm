...
insert into chop_start2001_pcornet.lab_result_cm (
	lab_result_cm_id,
	patid, encounterid,
...
from	 
	...
	join chop_start2001_pcornet.demographic d on cast(m.person_id as text)= d.patid
	join chop_start2001_pcornet.encounter e on cast(m.visit_occurrence_id as text) = e.encounterid
	...
	join chop_start2001_pcornet.cz_omop_pcornet_concept_map m1 on c1.concept_code = m1.source_concept_id and m1.source_concept_class = 'Lab name'
	--left join chop_start2001_pcornet.cz_omop_pcornet_concept_map m2 on c1.concept_code = m2.source_concept_id and m2.source_concept_class = 'Specimen source'
	left join chop_start2001_pcornet.cz_omop_pcornet_concept_map m3 on cast(m.operator_concept_id as text) = m3.source_concept_id and m3.source_concept_class = 'Result modifier'
	left join chop_start2001_pcornet.cz_omop_pcornet_concept_map m4 on cast(m.unit_concept_id as text)= m4.source_concept_id and m4.source_concept_class = 'Unit'
	left join chop_start2001_pcornet.cz_omop_pcornet_concept_map m5 on cast(m.range_low_operator_concept_id as text)= m5.source_concept_id and m5.source_concept_class = 'Result modifier'

...
insert into dcc_start2001_pcornet.enrollment (patid, enr_start_date, enr_end_date, chart, enr_basis, site)
select distinct 
...
where
	op.person_id IN (select person_id from dcc_start2001_pcornet.person_visit_start2001)

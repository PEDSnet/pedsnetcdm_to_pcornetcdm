...
From
	...
	join dcc_start2001_pcornet.demographic d on cast(de.person_id as text) = d.patid
	join vocabulary.concept on cause_source_concept_id = concept_id
	left join dcc_start2001_pcornet.cz_omop_pcornet_concept_map m1 on cast(vocabulary_id as text) = source_concept_id 

...
from
	...
	join dcc_start2001_pcornet.demographic d on d.patid = cast(co.person_id as text)
	left join dcc_start2001_pcornet.encounter e on e.encounterid = cast(co.visit_occurrence_id as text)
	...
	left join dcc_start2001_pcornet.cz_omop_pcornet_concept_map cz on cz.source_concept_id= c1.vocabulary_id and source_concept_class ='condition type'
where

...
left join pcornet_maps.pedsnet_pcornet_valueset_map imm_map on imm.immunization_source_value = imm_map.concept_description and imm_map.source_concept_class = 'vx_code_source'
